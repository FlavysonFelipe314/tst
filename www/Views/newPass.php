    ...
    <section class="login">
        ...
        <aside id="infos">
            <div class="container">
                ...
                <a href="<?= BASE_DIR?>/login">
                    <button class="bg-green-01">Login</button>
                </a>
            </div>            
        </aside>
        ...
        <aside id="credentials">
            <div class="container">
                ...
                <form method="POST" action="<?= BASE_DIR?>/novaSenha">
                    <input class="input-m1" type="password" id="senha" name="senha" placeholder="Senha">
                    <input class="input-m1" type="password" id="confirmarSenha" name="confirmarSenha" placeholder="Confirmar Senha">
